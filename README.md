...
| Measure | Value | Gate |
|---|---|---|
| BE-\* items bound to a named test | 112 of 112 declared, high-water ratchet at 112 | M1, enforced |
...
| Mutants killed by the test suite | 138 of 138 | M2, measured but **not** wired into the exit code |
