...
| **`G2-INTEROP-HANDSHAKE.md`** | D-092 gate G2 closing runbook: live Noise_IK handshake Go-initiator vs real daemon, staged A/B/C success ladder with observable criteria (metrics line), evidence list |
