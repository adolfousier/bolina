...
## D-095 - 2026-08-25 - G2 CLOSED LIVE, and the live run caught a real wire defect vectors could never see
...
**Gate scoreboard after this entry.** G3 CLOSED. G2 CLOSED (vectors + grant chain + live handshake). G1 UNLOCKED per owner sequencing: reviewer pack targets v0.6.1 with post-freeze disclosures; reviewer selection is the owner's move.
