...
**Gate scoreboard after this entry.** G3 CLOSED. G2 partially progressed (Go implementation passes frozen vectors byte-a-byte; grant chain + live interop handshake owed). G1 open, unlocked once G2 closes per owner sequencing; reviewer pack targets v0.6.1.
