...
| Implementation lines | **490** capability slice (`parser.zig` 284, `verify.zig` 182, `main.zig` 13, `tests.zig` 11) + round-4 attestation layer (`evidence.zig` 258, `dag.zig` 190, `evidence_test.zig` 451, `dag_test.zig` 230, `evidence_test_helpers.zig` 202). Fuzz and vector harnesses excluded. Current implementation total, re-measured 2026-08-06 after the parser split (D-032): **2235** (parser module 987: `parser.zig` 328, `parser/channel.zig` 405, `parser/session.zig` 254; `verify.zig` 200, `evidence.zig` 294, `dag.zig` 190, `mac.zig` 173, `replay.zig` 114, `reassembly.zig` 247, `main.zig` 13, `tests.zig` 17); dedicated test files total 2593; instrumentation and fuzz harness (`coverage.zig` 131, `fuzz.zig` 149) excluded. The parser module against its BE-SURF-03 budget: **987 of 1500** (M5). |
